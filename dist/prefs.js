...
const FolderPickRow = GObject.registerClass({
    ...
    Properties: {
        selected: GObject.ParamSpec.string('selected', 'selected', 'selected', GObject.ParamFlags.READWRITE, 'none')
    }
